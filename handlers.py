...
def start(update, context):
    ...
    context.bot.send_message(
        ...
        text=f"""username: {user_info["username"]}\nID заказа: {update.message.text.split()[1]}
        """,
    )
...
def forward_to_chat(update, context):
    """{ 
        'message_id': 5, 
        'date': 1605106546, 
        'chat': {'id': 49820636, 'type': 'private', 'username': 'danokhlopkov', 'https://github.com/sx000/telegram-support-bot': 'Daniil', 'last_name': 'Okhlopkov'}, 
        'text': 'TEST QOO', 'entities': [], 'caption_entities': [], 'photo': [], 'new_chat_members': [], 'new_chat_photo': [], 'delete_chat_photo': False, 'group_chat_created': False, 'supergroup_chat_created': False, 'channel_chat_created': False, 
        'from': {'id': 49820636, 'https://github.com/sx000/telegram-support-bot': 'Daniil', 'is_bot': False, 'last_name': 'Okhlopkov', 'username': 'danokhlopkov', 'language_code': 'en'}
    }"""
...
def forward_to_user(update, context):
    """{
        ...
        'reply_to_message': {
            ...
            'chat': {'id': -484179205, 'type': 'group', 'title': '☎️ SUPPORT CHAT', 'all_members_are_administrators': True}, 
            'forward_from': {'id': 49820636, 'https://github.com/sx000/telegram-support-bot': 'Daniil', 'is_bot': False, 'last_name': 'Okhlopkov', 'danokhlopkov': 'okhlopkov', 'language_code': 'en'}, 
            ...
            'from': {'id': 1440913096, 'https://github.com/sx000/telegram-support-bot': 'SUPPORT', 'is_bot': True, 'username': 'lolkek'}
        }, 
